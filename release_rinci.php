...
$tgl_release = dateSQL($_POST['tgl_release']);
$tgl_release_end = dateSQL($_POST['tgl_release_end']);
...
$sql = "SELECT top 500 *  FROM mafserverdb.financore.dbo.v_VaTempRekonRelease_new WHERE reconcile_status = 'A' and upload_date between '$tgl_release' AND '$tgl_release_end' and delchannel='$delchannel'";
  ...
  <table class="table table-bordered" id="data-table" border="1px solid rgb(190,190,190);">
      <thead>
          <tr>
            ...
            <th style="width: 8%;vertical-align:middle;">RELEASE AMOUNT</th>
            <th style="width: 12%;vertical-align:middle;">PAYMENT STATUS</th>
            <th style="width: 12%;vertical-align:middle;">RELEASE STATUS</th>
      ...
      <tbody>
          ...
          <?php
            ...
            $totalRelease += $data['rekon_amount'];
    ...
    <table class="table table-bordered" id="" border="1px solid rgb(190,190,190);">
      <tr>
        ...
        <td style="text-align:right; width:250px;">
          ...
          <strong><input type="text" class="form-control text-right total_payment" style="height:auto;padding:3px 5px;font-size:11px;color:#333;" id="total_payment" value="<?php echo number_format($totalAmount); ?>" readonly></strong>

          <input type="hidden" name="h_total_payment" class="h_total_payment" value="0">
        </td>
      </tr>
      <tr>
        <td style="width:560px;"><strong>Total Release Amount</strong></td>
        <td style="text-align:right; width:250px;">
          
          <strong><input type="text" class="form-control text-right total_release" style="height:auto;padding:3px 5px;font-size:11px;color:#333;" id="total_release" value="<?php echo number_format($totalRelease); ?>" readonly></strong>

          <input type="hidden" name="h_total_release" class="h_total_release" value="0">
        </td>
      </tr>
      <tr>
        <td style="width:560px;"><strong>Total Check Amount</strong></td>
        <td style="text-align:right; width:250px;">
      ...
      <tr>
        ...
        <td style="text-align:right;">
            ...
            <button type="submit" class="btn btn-sm btn-success" disabled="" style="height: 35px; font-size: 12px;" id="rekon_post_klik" value="rekon_post_klik" name="rekon_post_klik"><i class="glyphicon glyphicon-check" style="width: 20px;"> </i><b>RELEASE</b></button>
